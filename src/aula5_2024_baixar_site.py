...
# ==========================
SEEDS = [
    "https://www.dizerodireito.com.br/2024/",      # arquivo do ano (ponto de partida)
]
...
YEAR_PATH_RE = re.compile(rf"/{TARGET_YEAR}/")  # garante que pegamos conteúdo de 2024 no blog
...
def is_html_candidate(u: str) -> bool:
    # Só vamos "entrar" em páginas de 2024 do blog (para não varrer o site inteiro)
    if not is_allowed(u):
        return False
    if PDF_RE.search(u):
        return False
    # aceita /2024/ (arquivo do ano, posts e meses)
