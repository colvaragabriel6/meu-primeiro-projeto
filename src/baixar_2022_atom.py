#!/usr/bin/env python3
"""
Download informativos de 2022 extraindo links direto do feed Atom
"""
import os
import re
import requests
...
def baixar_infos_2022(tribunal, ano):
    """Baixa informativos de 2022 extraindo links do feed"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("📥 BAIXADOR DE INFORMATIVOS DE 2022")
    print("=" * 60)
    
    stf_baixados, stf_pulados = baixar_infos_2022("stf", 2022)
    stj_baixados, stj_pulados = baixar_infos_2022("stj", 2022)
    
    print("\n" + "=" * 60)
    print("✅ RESUMO")
    print("=" * 60)
    print(f"STF 2022: {stf_baixados} novo(s), {stf_pulados} existente(s)")
    print(f"STJ 2022: {stj_baixados} novo(s), {stj_pulados} existente(s)")
