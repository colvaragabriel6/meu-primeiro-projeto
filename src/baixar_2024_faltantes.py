#!/usr/bin/env python3
"""
Script para baixar informativos faltantes de 2024 via feed Atom
"""
...
# Informativos faltando em 2024
FALTANTES = {
    'stf': [1121, 1122, 1123, 1124, 1125, 1127, 1128, 1129, 1130, 1131, 1132, 1133, 1134],
    'stj': [800, 801, 802, 803, 804, 805, 807, 808, 809]
}
...
def main():
    print("\n" + "="*80)
    print("📥 DOWNLOAD DE INFORMATIVOS FALTANTES 2024")
    print("="*80)
    
    total_baixados = 0
    
    for tribunal in ['stf', 'stj']:
        print(f"\n🔎 {tribunal.upper()} 2024 ({len(FALTANTES[tribunal])} faltando)")
        print("-" * 40)
        
        # Extrair posts do feed
        posts = extrair_links_feed_atom(tribunal, '2024')
        ...
        if posts:
            ...
            for numero in FALTANTES[tribunal]:
                if numero in posts:
                    ...
                    print(f"  info-{numero}-{tribunal}: ✗ não encontrado no feed")
